...
public class v1_8_R2 implements NMS {
    ...
    public void sendTitle(Player player, String string) {
        ...
        IChatBaseComponent titleJSON = IChatBaseComponent.ChatSerializer.a("{'text': '" + string + "'}");
        PacketPlayOutTitle titlePacket = new PacketPlayOutTitle(PacketPlayOutTitle.EnumTitleAction.TITLE, titleJSON, 5, 65, 15);
