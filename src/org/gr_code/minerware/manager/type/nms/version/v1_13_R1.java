...
public class v1_13_R1 implements NMS {
    ...
    private final ParticleType[] enumParticles = new ParticleType[]
            {Particles.b, Particles.c, Particles.e, Particles.g, Particles.h,
                    Particles.u, Particles.y, Particles.z, Particles.A, Particles.t,
                    Particles.t, Particles.F, Particles.G, Particles.p, Particles.I, Particles.K,
                    Particles.g, Particles.M, Particles.E};
    ...
    public void updateBlocksWinEffect(Player player) {
        ...
        PacketPlayOutWorldParticles packetPlayOutWorldParticles = new PacketPlayOutWorldParticles(Particles.E, false , x, y+1.5f, z, 2, 0.5f, 0.5f, 0.5f, 3);
        PlayerConnection playerConnection = ((CraftPlayer)player).getHandle().playerConnection;
    ...
    public void sendActionBar(Player player, String text) {
        PlayerConnection playerConnection = ((CraftPlayer)player).getHandle().playerConnection;
        PacketPlayOutChat packetPlayOutChat = new PacketPlayOutChat(new ChatComponentText(text), ChatMessageType.GAME_INFO);
    ...
    public void updateFireWinEffect(Player player) {
        ...
        PacketPlayOutWorldParticles packetPlayOutWorldParticles = new PacketPlayOutWorldParticles(Particles.G, false , x, y+1.5f, z, 0.5f, 0.3f, 0.5f, 2.5f, 8);
        PlayerConnection playerConnection = ((CraftPlayer)player).getHandle().playerConnection;
    ...
    public void updateRocketWinEffect(Player player, int stage) {
        ...
        PacketPlayOutWorldParticles packetPlayOutWorldParticlesFlame = new PacketPlayOutWorldParticles(Particles.G, false ,(float) x,(float) y, (float) z, 0.1f, 0, 0.1f, 0.1f, Math.max(4, stage / 20));
    ...
    public void updateExplosionWinEffect(Player player, int stage) {
        ...
        int z = location.getBlockZ();
        if(stage < 70){
            PacketPlayOutWorldParticles packetPlayOutWorldParticles = new PacketPlayOutWorldParticles(Particles.t, false , x, y+1.5f, z, 10, 10.5f, 10.5f, 1.5f, 4);
            PacketPlayOutWorldParticles packetPlayOut = new PacketPlayOutWorldParticles(Particles.G, false , x, y+1.5f, z, 10, 7.5f, 7.5f, 1.5f, 25);
            PlayerConnection playerConnection = ((CraftPlayer)player).getHandle().playerConnection;
            playerConnection.sendPacket(packetPlayOutWorldParticles);
        ...
        PacketPlayOutWorldParticles packetPlayOutWorldParticles = new PacketPlayOutWorldParticles(Particles.F, false , x, y+1.5f, z, 2, 0.5f, 0.5f, 0.05f, 13);
        PlayerConnection playerConnection = ((CraftPlayer)player).getHandle().playerConnection;
        playerConnection.sendPacket(packetPlayOutWorldParticles);
    }
